...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_yourusername_subscription-service_internal_model.Subscription"
                            }
                        }
                    },
                    "500": {
    ...
    "definitions": {
        "github_com_yourusername_subscription-service_internal_model.Subscription": {
            "type": "object",
            "properties": {
                "end_date": {
                ...
                "start_date": {
                    "description": "Месяц и год начала",
                    "type": "string"
                },
                "user_id": {
